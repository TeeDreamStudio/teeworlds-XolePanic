...
MACRO_CONFIG_STR(SvName, sv_name, 128, "XolePanic Server", CFGFLAG_SERVER, "Server name")
...
MACRO_CONFIG_STR(SvDefaultLanguage, sv_default_language, 16, "zh-cn", CFGFLAG_SERVER, "Server default language")
